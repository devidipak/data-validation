...
class _PartialCommonStats(object):
  ...
  def update(self,
    ...
    if value is not None:
      ...
      self.min_num_values = min(self.min_num_values, num_values)
      self.max_num_values = max(self.max_num_values, num_values)
...
class _PartialNumericStats(object):
  ...
  def update(
    ...
    for v in value:
      ...
      values_and_weights_numeric_feat[0].append(v)
